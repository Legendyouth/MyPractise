    ...
    <div class="login-container">
        ...
        >
            ...
            <span slot="footer" class="dialog-footer" style="text-align:center">
                ...
                <el-button @click="registered">Sign up</el-button>
            </span>
        </el-dialog>
    </div>
</template>
...
export default {
    ...
    methods: {
        getLoginMessage() {
            ...
            Service('/internal/auth/login', params).then(res => {
                if(res.errcode === 200) {
                    ...
                    this.tips.cTip = res.errmsg + '请核对用户名密码后再次尝试！';
                }
            });
        },
        checkInput() {
        ...
        login() {
            this.checkInput() && this.getLoginMessage();
        },
        registered() {
            this.$router.push({
                path: '/register',
